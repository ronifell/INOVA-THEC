...
export default function ModuleActionButton({
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.98 }}
      onClick={onClick}
      className="relative overflow-hidden rounded-lg px-3 py-2 text-left min-w-[7rem] border antialiased"
      style={{
        borderColor: `rgba(${accentRgb}, 0.35)`,
        background: `linear-gradient(135deg, rgba(${accentRgb}, 0.12), rgba(${accentRgb}, 0.03))`,
        color: accent,
