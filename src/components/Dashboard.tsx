  ...
  return (
    <div className="flex h-full min-h-0 w-full flex-col overflow-x-hidden px-[2.5%] pb-[0.6vh] pt-[0.8vh]">
      <div className="flex min-h-0 flex-1 flex-col">
        ...
        <div className="mx-auto mt-[min(2vh,2vmin)] flex min-h-0 w-full max-w-[98%] flex-1 flex-col gap-[min(3.5vmin,3vh)]">
          <div className="module-cards-glow-gutter min-h-0 w-full min-w-0 flex-[1.06]">
          ...
          <div className="mt-[min(0.9vh,1vmin)] flex min-h-0 min-w-0 flex-[1.18] flex-col overflow-hidden">
            <AuditCarousel />
          </div>
        </div>
      </div>
