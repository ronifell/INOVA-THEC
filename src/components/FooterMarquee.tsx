...
export default function FooterMarquee() {
  ...
  return (
    <div className="w-full max-w-full select-none overflow-hidden border-y border-white/[0.08] bg-black/10 py-[min(1.05vmin,0.78vh)]">
      <div
        className="flex max-w-none whitespace-nowrap font-mono text-[9px] font-semibold leading-snug tracking-tight text-emerald-300 [text-shadow:0_0_8px_rgba(16,185,129,0.45)] will-change-transform md:text-[10px]"
