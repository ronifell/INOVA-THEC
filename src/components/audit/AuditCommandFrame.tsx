...
export default function AuditCommandFrame({
  ...
  const innerClass = contentFullWidth
    ? "relative z-[1] mx-auto flex h-full min-h-0 w-full min-w-0 max-w-full flex-1 flex-col px-0"
    : "relative z-[1] mx-auto flex h-full min-h-0 w-full max-w-[min(100%,calc(100%-clamp(2.75rem,7.5vmin,5.5rem)))] min-w-0 flex-1 flex-col px-[clamp(0.6rem,2vmin,1.35rem)]";
